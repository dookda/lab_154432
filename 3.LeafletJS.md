Leaflet.js เป็นไลบรารี JavaScript แบบโอเพ่นซอร์สที่เบาและใช้งานง่าย สำหรับสร้างแผนที่แบบโต้ตอบบนเว็บไซต์ โดยไม่จำเป็นต้องใช้งาน Map Provider หรือ API ที่ยุ่งยากมากนัก
